...
namespace VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<global::VideoManager.Infrastructure.Immich.Generated.Models.TimeBucketAssetResponseDto> GetAsync(Action<RequestConfiguration<global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::VideoManager.Infrastructure.Immich.Generated.Models.TimeBucketAssetResponseDto>(requestInfo, global::VideoManager.Infrastructure.Immich.Generated.Models.TimeBucketAssetResponseDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve a string of all asset ids in a given time bucket.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder WithUrl(string rawUrl)
        {
            return new global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a string of all asset ids in a given time bucket.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Sort order for assets within time buckets (ASC for oldest first, DESC for newest first)</summary>
            [QueryParameter("order")]
            public global::VideoManager.Infrastructure.Immich.Generated.Models.AssetOrder? OrderAsAssetOrder { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BucketRequestBuilderGetRequestConfiguration : RequestConfiguration<global::VideoManager.Infrastructure.Immich.Generated.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>
        {
        }
    }
}
